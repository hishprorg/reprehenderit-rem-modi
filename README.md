...
![Version](https://img.shields.io/npm/v/@hishprorg/reprehenderit-rem-modi?style=for-the-badge&label=Version)
[![Parent Script Version](https://img.shields.io/badge/Parent%20Script%20Version-v2.6.16-blue?style=for-the-badge)](https://github.com/add2cal/add-to-calendar-button)
[![npm bundle size](https://img.shields.io/bundlephobia/minzip/@hishprorg/reprehenderit-rem-modi?style=for-the-badge)](https://www.npmjs.com/package/@hishprorg/reprehenderit-rem-modi)
[![npm Installations](https://img.shields.io/npm/dt/@hishprorg/reprehenderit-rem-modi?label=npm%20Installations&style=for-the-badge)](https://www.npmjs.com/package/@hishprorg/reprehenderit-rem-modi)
...
![Supported Calendars: Apple (via iCal), Google, Microsoft (365, Outlook, Teams), Yahoo, generic iCal](https://github.com/hishprorg/reprehenderit-rem-modi/blob/main/assets/badge-supported-calendars.svg)
...
```sh
npm install @hishprorg/reprehenderit-rem-modi
```
...
```javascript
import { AddToCalendarButton } from '@hishprorg/reprehenderit-rem-modi';
```
...
```javascript
import type { AddToCalendarButtonType } from '@hishprorg/reprehenderit-rem-modi';
```
